...
Ker-SVM : Qilong Wang implemented a one-vs-all classifier [37] by using LIBSVM package in the paper:
		Q. Wang, P. Li, W. Zuo, and L. Zhang. Raid-g: Robust estimation of approximate infinite dimensional gaussian with application to material recognition. In Proceedings of the IEEE Conference on Computer Vision and Pattern Recognition, pages 4433â€?441, 2016.
LogEKSR : This method was proposed in the paper:
		...
		In Proceedings of the IEEE International Conference on Computer Vision, pages 1601â€?608, 2013.
COV-LDA/COV-PLS :  This method was proposed in the paper:
		...
		In Computer Vision and Pattern Recognition (CVPR), 2012 IEEE Conference on, pages 2496â€?503. IEEE, 2012. 